...
LOAD DATA LOCAL INFILE '/Project2_Phase2/course.csv' INTO TABLE Course FIELDS TERMINATED BY ',' ENCLOSED BY '"' IGNORE 1 ROWS;

LOAD DATA LOCAL INFILE '/Project2_Phase2/_CoursesTaught.csv' INTO TABLE Course FIELDS TERMINATED BY ',' ENCLOSED BY '"' IGNORE 1 ROWS;

LOAD DATA LOCAL INFILE '/Project2_Phase2/instructor.csv' INTO TABLE Course FIELDS TERMINATED BY ',' ENCLOSED BY '"' IGNORE 1 ROWS;

LOAD DATA LOCAL INFILE '/Project2_Phase2/_TT.csv' INTO TABLE Course FIELDS TERMINATED BY ',' ENCLOSED BY '"' IGNORE 1 ROWS;

LOAD DATA LOCAL INFILE '/Project2_Phase2/_PhDStudent.csv' INTO TABLE Course FIELDS TERMINATED BY ',' ENCLOSED BY '"' IGNORE 1 ROWS;

LOAD DATA LOCAL INFILE '/Project2_Phase2/_GRA.csv' INTO TABLE Course FIELDS TERMINATED BY ',' ENCLOSED BY '"' IGNORE 1 ROWS;

LOAD DATA LOCAL INFILE '/Project2_Phase2/_GTA.csv' INTO TABLE Course FIELDS TERMINATED BY ',' ENCLOSED BY '"' IGNORE 1 ROWS;

LOAD DATA LOCAL INFILE '/Project2_Phase2/_SelfSupport.csv' INTO TABLE Course FIELDS TERMINATED BY ',' ENCLOSED BY '"' IGNORE 1 ROWS;

LOAD DATA LOCAL INFILE '/Project2_Phase2/_ScholarshipSupport.csv' INTO TABLE Course FIELDS TERMINATED BY ',' ENCLOSED BY '"' IGNORE 1 ROWS;

LOAD DATA LOCAL INFILE '/Project2_Phase2/_Grants.csv' INTO TABLE Course FIELDS TERMINATED BY ',' ENCLOSED BY '"' IGNORE 1 ROWS;

LOAD DATA LOCAL INFILE '/Project2_Phase2/_GrantAssociated.csv' INTO TABLE Course FIELDS TERMINATED BY ',' ENCLOSED BY '"' IGNORE 1 ROWS;

LOAD DATA LOCAL INFILE '/Project2_Phase2/_Milestone.csv' INTO TABLE Course FIELDS TERMINATED BY ',' ENCLOSED BY '"' IGNORE 1 ROWS;

LOAD DATA LOCAL INFILE '/Project2_Phase2/_MilestonesPassed.csv' INTO TABLE Course FIELDS TERMINATED BY ',' ENCLOSED BY '"' IGNORE 1 ROWS;

LOAD DATA LOCAL INFILE '/Project2_Phase2/_PhDCommittee.csv' INTO TABLE Course FIELDS TERMINATED BY ',' ENCLOSED BY '"' IGNORE 1 ROWS;

LOAD DATA LOCAL INFILE '/Project2_Phase2/_Section.csv' INTO TABLE Course FIELDS TERMINATED BY ',' ENCLOSED BY '"' IGNORE 1 ROWS;
...
P.StSem as SStSem, 
 ...
 /*Show all the records in the view table */
